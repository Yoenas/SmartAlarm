...
//        if (isDateInvalid(date, DATE_FORMAT) || isDateInvalid(time, TIME_FORMAT)) return
        ...
        Log.e("OneTimeAlarmManager", "$date $time")
    ...
    fun cancelAlarm(context: Context, type: Int) {
        ...
        val requestCode = when (type) {
            ...
            TYPE_REPEATING -> ID_REPEATING
                ...
                Log.i("CancelAlarm", "Unknown type of Alarm.")
            }
        }
        ...
        if (type == TYPE_ONE_TIME) {
            Toast.makeText(context, "An OneTime Alarm Canceled.", Toast.LENGTH_SHORT).show()
        } else {
            Toast.makeText(context, "A Repeating Alarm Canceled", Toast.LENGTH_SHORT).show()
        }
    }
    ...
    companion object {
        ...
        private const val ID_ONE_TIME = 0
